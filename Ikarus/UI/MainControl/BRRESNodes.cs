...
namespace Ikarus.UI
{
    public partial class MainControl : UserControl, IMainWindow
    {
        ...
        {
            if (!syncAnimationsTogetherToolStripMenuItem.Checked && focusType != AnimType.None)
                return;
        ...
        public bool GetCLR0(AnimType focusType)
        {
            ...
            if (TargetModel != null && (_clr0 = (CLR0Node)TargetModel.RootNode.FindChildByType(focusFile.Name, true, ResourceType.CLR0)) != null)
                return true;
            if (FileManager.Animations != null && (_clr0 = (CLR0Node)FileManager.Animations.FindChildByType(focusFile.Name, true, ResourceType.CLR0)) != null)
                return true;
            return false;
        }
        public bool GetVIS0(AnimType focusType)
        {
            ...
            if (TargetModel != null && (_vis0 = (VIS0Node)TargetModel.RootNode.FindChildByType(focusFile.Name, true, ResourceType.VIS0)) != null)
                return true;
            if (FileManager.Animations != null && (_vis0 = (VIS0Node)FileManager.Animations.FindChildByType(focusFile.Name, true, ResourceType.VIS0)) != null)
                return true;
            return false;
        }
        public bool GetPAT0(AnimType focusType)
        {
            ...
            if (TargetModel != null && (_pat0 = (PAT0Node)TargetModel.RootNode.FindChildByType(focusFile.Name, true, ResourceType.PAT0)) != null)
                return true;
            if (FileManager.Animations != null && (_pat0 = (PAT0Node)FileManager.Animations.FindChildByType(focusFile.Name, true, ResourceType.PAT0)) != null)
                return true;
            return false;
        }
        public bool GetSRT0(AnimType focusType)
        {
            ...
            if (TargetModel != null && (_srt0 = (SRT0Node)TargetModel.RootNode.FindChildByType(focusFile.Name, true, ResourceType.SRT0)) != null)
                return true;
            if (FileManager.Animations != null && (_srt0 = (SRT0Node)FileManager.Animations.FindChildByType(focusFile.Name, true, ResourceType.SRT0)) != null)
                return true;
            return false;
        }
        public bool GetSHP0(AnimType focusType)
        {
            ...
            if (TargetModel != null && (_shp0 = (SHP0Node)TargetModel.RootNode.FindChildByType(focusFile.Name, true, ResourceType.SHP0)) != null)
                return true;
            if (FileManager.Animations != null && (_shp0 = (SHP0Node)FileManager.Animations.FindChildByType(focusFile.Name, true, ResourceType.SHP0)) != null)
                return true;
            return false;
        }
        public bool GetCHR0(AnimType focusType)
        {
            ...
            if (TargetModel != null && (_chr0 = (CHR0Node)TargetModel.RootNode.FindChildByType(focusFile.Name, true, ResourceType.CHR0)) != null)
                return true;
            if (FileManager.Animations != null && (_chr0 = (CHR0Node)FileManager.Animations.FindChildByType(focusFile.Name, true, ResourceType.CHR0)) != null)
                return true;
            return false;
        }
