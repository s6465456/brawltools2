    ...
    public unsafe class MoveDefNode : ARCEntryNode
    {
        ...
        public void LoadEventDictionary()
        {
            ...
            EventDictionary.Add(0x02040100, new ActionEventInfo(0x02040100, "Additional Change Action Requirement",
                ...
                "\\name() \\value(0)",
                new long[] { 6 }));
            EventDictionary.Add(0x02040200, new ActionEventInfo(0x02040200, "Additional Change Action Requirement Value",
                "Add an additional requirement to the preceeding Change Action statement.",
                new string[] { "Requirement", "Variable" },
                new string[] { "The form of requirement used in evaluation of the event.", "The variable applied to the requirement." },
                "\\name() \\value(0): \\value(1)",
                new long[] { 6, 5 }));
            EventDictionary.Add(0x02040400, new ActionEventInfo(0x02040400, "Additional Change Action Requirement Comparison",
                "Add an additional requirement to the preceeding Change Action statement.",
                new string[] { "Requirement", "Variable", "Comparison Method", "Variable" },
                new string[] { "The form of requirement used in evaluation of the event.", "The first variable in the comparison requirement.", "The method used to compare the two variables. From 0 to 5: <, ≤, =, ≠, ≥, > ", "The second variable in the comparison requirement." },
            ...
            EventDictionary.Add(0x020A0100, new ActionEventInfo(0x020A0100, "Allow Specific Interrupt",
                ...
                "\\name(): \\enum(\\value(0), 0)",
                new long[] { 0 }) { Enums = new Dictionary<int, List<string>>() { { 0, new List<string>() { "Undefined(0)", "Ground Special", "Ground Item", "Ground Catch", "Ground Attack", "Ground Escape", "Ground Guard", "Ground Jump", "Ground (Other)", "Air Landing", "Grab Edge", "Air Special", "Air Item Throw", "Air Lasso", "Air Dodge", "Air Attack", "Air Tread Jump", "Air Walljump", "Air Jump Aerial", "Fall Through Platform (Squat Only)" } } } });
            ...
            EventDictionary.Add(0x10040100, new ActionEventInfo(0x10040100, "Model Event 1",
                ...
                new long[] { }));
            EventDictionary.Add(0x10040200, new ActionEventInfo(0x10040200, "Set Anchored Article Action",
                ...
                new long[] { 0, 0 }));
            EventDictionary.Add(0x10040300, new ActionEventInfo(0x10040300, "Set Anchored Article Action",
                "Sets the specified article to execute the specified action immediately. Only works on anchored articles (Cape, FLUDD, not fireball, water).",
            ...
            EventDictionary.Add(0x02090200, new ActionEventInfo(0x02090200, "Invert Action Status ID",
                ...
                new long[] { 0, 0 }) { Enums = new Dictionary<int, List<string>>() { { 0, new List<string>() { "Undefined(0)", "Ground Special", "Ground Item", "Ground Catch", "Ground Attack", "Ground Escape", "Ground Guard", "Ground Jump", "Ground (Other)", "Air Landing", "Grab Edge", "Air Special", "Air Item Throw", "Air Lasso", "Air Dodge", "Air Attack", "Air Tread Jump", "Air Walljump", "Air Jump Aerial", "Fall Through Platform (Squat Only)" } } } });
            ...
            EventDictionary.Add(0x04020100, new ActionEventInfo(0x04020100, "Additional Subaction Change Requirement",
                ...
                "\\name(): \\value(0)",
                new long[] { 6 }));
            EventDictionary.Add(0x04020200, new ActionEventInfo(0x04020200, "Additional Subaction Change Requirement Value",
                "",
                new string[] { "Requirement", "Variable" },
                new string[] { "The form of requirement used in evaluation of the event.", "The variable applied to the requirement." },
                "\\name(): \\value(0): \\value(1)",
                new long[] { 6, 5 }));
            EventDictionary.Add(0x04020300, new ActionEventInfo(0x04020300, "Additional Subaction Change Requirement Unknown",
                "",
                new string[] { "Requirement", "Variable", "Undefined" },
                new string[] { "The form of requirement used in evaluation of the event.", "The variable applied to the requirement.", "Undefined" },
                "\\name(): \\value(0): \\value(1), \\value(2)",
                new long[] { 6, 5, 0 }));
            EventDictionary.Add(0x04020400, new ActionEventInfo(0x04020400, "Additional Subaction Change Requirement Compare",
                "",
                new string[] { "Requirement", "Variable", "Comparison Method", "Variable" },
                new string[] { "The form of requirement used in evaluation of the event.", "The first variable in the comparison requirement.", "The method used to compare the two variables. From 0 to 5: <, ≤, =, ≠, ≥, >", "The second variable in the comparison requirement." },
                "\\name(): \\value(0): \\value(1) \\cmpsign(\\value(2)) \\value(3)",
            ...
            EventDictionary.Add(0x04030200, new ActionEventInfo(0x04030200, "Extra Subaction Change Requirement Value",
                ...
                "\\name(): \\value(0): \\value(1)",
                new long[] { 6, 5 }));
            EventDictionary.Add(0x04030300, new ActionEventInfo(0x04030300, "Extra Subaction Change Requirement Unknown",
                "",
                new string[] { "Requirement", "Variable", "Undefined" },
                new string[] { "The form of requirement used in evaluation of the event.", "The variable applied to the requirement.", "Undefined" },
                "\\name(): \\value(0): \\value(1), \\value(2)",
                new long[] { 6, 5, 0 }));
            EventDictionary.Add(0x04030400, new ActionEventInfo(0x04030400, "Extra Subaction Change Requirement Compare",
                "",
                new string[] { "Requirement", "Variable", "Comparison Method", "Variable" },
                new string[] { "The form of requirement used in evaluation of the event.", "The first variable in the comparison requirement.", "The method used to compare the two variables. From 0 to 5: <, ≤, =, ≠, ≥, > ", "The second variable in the comparison requirement." },
                "\\name(): \\value(0): \\value(1) \\cmpsign(\\value(2)) \\value(3)",
            ...
            EventDictionary.Add(0x14050100, new ActionEventInfo(0x14050100, "Aesthetic Wind 05",
                ...
                "",
                new long[] { 3 }));
            EventDictionary.Add(0x10070200, new ActionEventInfo(0x10070200, "Set Static Article Action",
            ...
            EventDictionary.Add(0x17000000, new ActionEventInfo(0x17000000, "Physics Normalize",
                ...
                "",
                new long[] { }));
            EventDictionary.Add(0x10080200, new ActionEventInfo(0x10080200, "Set Static Article Action",
            ...
            EventDictionary.Add(0x02020300, new ActionEventInfo(0x02020300, "Unknown",
                ...
                "",
                new long[] { 0, 0, 6 }));
            EventDictionary.Add(0x02040300, new ActionEventInfo(0x02040300, "Additional Change Action Requirement Value",
                "Add an additional requirement to the preceeding Change Action statement.",
                new string[] { "Requirement", "Variable", "Undefined" },
                new string[] { "The form of requirement used in evaluation of the event.", "The variable applied to the requirement.", "Undefined" },
                "",
        ...
        public List<MoveDefExternalNode> _external;
        public MoveDefExternalNode IsExternal(int offset)
        {
            foreach (MoveDefExternalNode e in _external)
        ...
        public int GetOffset(int list, int type, int index)
        {
            ...
            if (list == 3)
                if (_external.Count > index)
                    return ((MoveDefEntryNode)_external[index])._offset;
        ...
        public void GetLocation(int offset, out int list, out int type, out int index)
        {
            ...
            if ((dataCommon != null && data == null) || offset == -1)
            {
                list = 4; //Null
                done = true;
            }
        ...
        public Dictionary<int, List<MoveDefEventNode>> _events;
        ...
        public Dictionary<int, MoveDefActionNode> _subRoutines;
        ...
        {
            _subRoutines = new Dictionary<int, MoveDefActionNode>();
            _external = new List<MoveDefExternalNode>();
            _lookupSizes = new Dictionary<int, MoveDefLookupOffsetNode>();
            _events = new Dictionary<int, List<MoveDefEventNode>>();
