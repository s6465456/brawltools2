...
namespace BrawlBox.NodeWrappers
{
    ...
    class MDefWrapper : GenericWrapper
    {
        ...
        static MDefWrapper()
        {
            ...
            _menu.Items.Add(new ToolStripMenuItem("&Save Info to Text Files", null, SaveDataAction, Keys.Control | Keys.T));
        ...
        protected static void LoadModelAction(object sender, EventArgs e) { GetInstance<MDefWrapper>().LoadModel(); }
        protected static void SaveDataAction(object sender, EventArgs e) { GetInstance<MDefWrapper>().SaveMovesetData(); }
        ...
        public MDefWrapper() { ContextMenuStrip = _menu; }

        public override string ExportFilter { get { return ExportFilters.MDef; } }

        public void LoadModel()
        {
            OpenFileDialog o = new OpenFileDialog();
            o.Filter = "All Available Formats (*.mdl0, *.pac)|*.mdl0;*.pac|" + "MDL0 Raw Model (*.mdl0)|*.mdl0|" + "PAC Archive (*.pac)|*.pac";
        ...
        public void SaveAttributes()
        {
            ...
            if (File.Exists(Params))
                if (MessageBox.Show("Do you want to overwrite " + _resource.Parent.Name + ".txt in the MovesetData/CharSpecific folder?", "Overwrite Permission", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    go = true;
                else
                    go = false;
            else
            ...
            if (go)
                ...
                {
                    foreach (var i in node.Params)
                    {
                        file.WriteLine(i.Key);
                        file.WriteLine(i.Value.NewName);
                        foreach (AttributeInfo a in i.Value.Attributes)
                        {
    ...
    class MDefEventWrapper : GenericWrapper
    {
        ...
        protected static void EditDictionaryName(object sender, EventArgs e) { GetInstance<MDefEventWrapper>().EditDictionaryName(); }
        protected static void EditDictionaryDescription(object sender, EventArgs e) { GetInstance<MDefEventWrapper>().EditDictionaryDescription(); }
        protected static void EditDictionarySyntax(object sender, EventArgs e) { GetInstance<MDefEventWrapper>().EditDictionarySyntax(); }
        ...
        public MDefEventWrapper() { ContextMenuStrip = _menu; }
    ...
    class MDefEventParameterWrapper : GenericWrapper
    {
        ...
        protected static void EditDictionaryName(object sender, EventArgs e) { GetInstance<MDefEventParameterWrapper>().EditDictionaryName(); }
        protected static void EditDictionaryDescription(object sender, EventArgs e) { GetInstance<MDefEventParameterWrapper>().EditDictionaryDescription(); }
        ...
        public MDefEventParameterWrapper() { ContextMenuStrip = _menu; }
    ...
    class MDefHurtboxListWrapper : GenericWrapper
    {
        ...
        protected static void NewHurtboxAction(object sender, EventArgs e) { GetInstance<MDefHurtboxListWrapper>().NewHurtbox(); }
        private static void MenuClosing(object sender, ToolStripDropDownClosingEventArgs e) { }
        private static void MenuOpening(object sender, CancelEventArgs e) { }
        #endregion

        public MDefHurtboxListWrapper() { ContextMenuStrip = _menu; }
    ...
    class MDefActionListWrapper : GenericWrapper
    {
        ...
        protected static void NewAction(object sender, EventArgs e) { GetInstance<MDefActionListWrapper>().NewActionGroup(); }
        private static void MenuClosing(object sender, ToolStripDropDownClosingEventArgs e) { }
        private static void MenuOpening(object sender, CancelEventArgs e) { }
        #endregion

        public MDefActionListWrapper() { ContextMenuStrip = _menu; }
    ...
    class MDefSubActionGroupWrapper : GenericWrapper
    {
        ...
        public MDefSubActionGroupWrapper() { ContextMenuStrip = _menu; }
    }
    ...
    class MDefActionGroupWrapper : GenericWrapper
    {
        ...
        protected static void MoveUp2Action(object sender, EventArgs e) { GetInstance<MDefActionGroupWrapper>().MoveUp2(); }
        protected static void MoveDown2Action(object sender, EventArgs e) { GetInstance<MDefActionGroupWrapper>().MoveDown2(); }
        protected static void Delete2Action(object sender, EventArgs e) { GetInstance<MDefActionGroupWrapper>().Delete2(); }
        private static void MenuClosing(object sender, ToolStripDropDownClosingEventArgs e)
        {
        ...
        public MDefActionGroupWrapper() { ContextMenuStrip = _menu; }

        public void MoveUp2()
        {
            ResourceNode n = null;
            if ((n = _resource.Parent.Parent) is MoveDefArticleNode || (n = _resource.Parent.Parent.Parent) is MoveDefArticleNode)
            {
    ...
    class MDefMdlVisRefWrapper : GenericWrapper
    {
        ...
        protected static void NewSwitchAction(object sender, EventArgs e) { GetInstance<MDefMdlVisRefWrapper>().NewSwitch(); }
        private static void MenuClosing(object sender, ToolStripDropDownClosingEventArgs e)
        {
            _menu.Items[2].Enabled = _menu.Items[3].Enabled = _menu.Items[6].Enabled = true;
        }
        ...
        public MDefMdlVisRefWrapper() { ContextMenuStrip = _menu; }
    ...
    class MDefMdlVisSwitchWrapper : GenericWrapper
    {
        ...
        public MDefMdlVisSwitchWrapper() { ContextMenuStrip = _menu; }
    ...
    class MDefMdlVisGroupWrapper : GenericWrapper
    {
        ...
        protected static void NewBoneAction(object sender, EventArgs e) { GetInstance<MDefMdlVisGroupWrapper>().NewBone(); }
        private static void MenuClosing(object sender, ToolStripDropDownClosingEventArgs e)
        {
            _menu.Items[2].Enabled = _menu.Items[3].Enabled = _menu.Items[6].Enabled = true;
        }
        ...
        public MDefMdlVisGroupWrapper() { ContextMenuStrip = _menu; }
